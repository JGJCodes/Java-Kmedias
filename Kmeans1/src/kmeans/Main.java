...
public class Main {
   ...
   //Metodo principal de la clase
    ...
    public static void Menu(){
        short opcion = 0;
          while(opcion!=2){
               ...
               switch(opcion){
                    case 1:Main.ClasificarPuntos(); break;
                    case 2:System.out.println("***Fin del programa****"); Leer.dato(); break;
    ...
    public static void ClasificarPuntos(){
        ...
        char distancia = Main.ElegirDistancia();
        System.out.println("***********************");
    ...
    public static void ImprimirResultados(Kmeans resultados, int iteraciones){
        ...
        for(int i=0;i<resultados.Ejemplos.length;i++){
            System.out.println(resultados.Ejemplos[i].getX() + "\t" + resultados.Ejemplos[i].getY() + "\t" + resultados.Ejemplos[i].getC());
        }
        System.out.println("***********************");
        System.out.println("*Centroides************");
        System.out.println("X\tY\tGrupo");
        for(int i=0;i<resultados.Centroides.length;i++){
            System.out.println(resultados.Centroides[i].getX() + "\t" + resultados.Centroides[i].getY() + "\t" + resultados.Centroides[i].getC());
        }
        System.out.println("***********************");
